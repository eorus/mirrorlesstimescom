...
The comparison table below **summarizes the key specs** of the two cameras. Below that, we specifically talk about the new improvements and which model is better suited for your needs.<!--more-->
